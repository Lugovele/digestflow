...
FINAL_POST_AGENT_ACCESS_CONTRACTS = {
    ROLE_CANDIDATE_WRITER: FinalPostAgentAccessContract(
        ...
        allowed_outputs=("FinalPostPayload", "PostGenerationMetadata"),
        allowed_payload_actions=("create_first_payload",),
        forbidden_payload_fields=(),
        may_create_final_post_payload=True,
    ...
    ROLE_DETERMINISTIC_GATE: FinalPostAgentAccessContract(
        ...
        allowed_inputs=("FinalPostPayload", "selected_evidence_ids"),
