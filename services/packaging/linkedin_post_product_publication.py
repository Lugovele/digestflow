...
def _build_product_attempt_request(
    *,
    ...
    request = FinalPostAttemptRequest(
        ...
        candidate_writer_provider=settings.POSTFLOW_CANDIDATE_WRITER_PROVIDER,
        candidate_writer_model=settings.POSTFLOW_CANDIDATE_WRITER_MODEL,
        quality_evaluator_provider=settings.POSTFLOW_QUALITY_EVALUATOR_PROVIDER,
        quality_evaluator_model=settings.POSTFLOW_QUALITY_EVALUATOR_MODEL,
        attempt_index=0,
        max_attempts=1,
