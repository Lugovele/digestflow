...
def _repair_writer_target_guidance(repair_instruction: Any) -> str:
    ...
    if failed_criterion == REPAIR_WRITER_CTA_CRITERION:
        return (
            ...
            "angle. Replace or sharpen the ending only. Do not modify unrelated "
            "sections. Do not rewrite the full post. Do not add a second CTA. Do "
            "not add extra author-presence markers.\n\n"
    ...
    if failed_criterion == REPAIR_WRITER_AUTHOR_POV_CRITERION:
        return (
            ...
            "The repaired target locus must visibly attribute the interpretation "
            "to the author. An impersonal judgment does NOT satisfy this repair, "
            "even when the judgment is analytically strong. The repaired target "
            "locus must contain exactly one explicit ownership signal, such as I "
            "see, I reject, I do not think, I don't think, I would treat this as, "
            "or I would not treat X as Y, and that signal must carry the "
            "evidence-bounded judgment. Impersonal analytical phrases such as the "
            "mistake is, the real picture is, this means, growth evidence doesn't "
            "erase risk, or that reading is wrong may support the argument "
            "elsewhere, but they do not satisfy this repair target by themselves. "
            "The ownership marker alone is also insufficient: avoid generic filler "
            "such as I think this is important, In my view this matters, or I "
            "believe the market is complicated. Do not add a separate first-person "
            "preface. Convert the target sentence itself into one substantive, "
            "evidence-bounded, author-owned interpretation. Do not invent personal "
            "experience, biography, emotion, authority, or market exposure. Do not "
            "paraphrase distinctive sentences merely for style.\n\n"
            "AUTHOR POV LOCALITY EXAMPLES:\n"
            "BAD: The mistake is treating these signals as proof that risk has been "
            "resolved. Reason: still impersonal.\n"
            "BAD: In my view, this is important. Reason: ownership without "
            "substantive interpretation.\n"
            "BAD: The mistake is treating these signals as proof. I think this "
            "matters. Reason: adds generic ownership instead of converting the "
            "target locus.\n"
            "BAD: I've seen this happen many times. Reason: unsupported personal "
            "experience.\n"
            "GOOD: Original: Treating these signals as proof that risk has been "
            "resolved is a mistake. Repaired: I would not treat these signals as "
            "proof that risk has been resolved. Why good: same analytical content, "
            "same locus, explicit ownership, minimal edit.\n"
            "GOOD: Original: The evidence does not justify calling this settled. "
            "Repaired: I don't think the evidence justifies calling this settled."
        )
    return (
        "TARGETED REPAIR:\n"
