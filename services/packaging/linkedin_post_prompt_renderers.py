...
def _repair_writer_target_guidance(repair_instruction: Any) -> str:
    ...
    if failed_criterion == REPAIR_WRITER_AUTHOR_POV_CRITERION:
        return (
            ...
            "The intended repair region is one existing local interpretive sentence "
            "or clause. Preserve the hook, evidence body, CTA, controlling angle, "
            "surrounding post, and existing distinctive phrasing. Replace or sharpen "
            "the existing sentence so there is exactly one explicit author-owned, "
            "evidence-bounded, isolated interpretation. Do not append another "
            "interpretation. Do not broadly rewrite the post. Do not add multiple "
            "first-person markers or stacked identity markers. Do not change the CTA "
            "unless required by hard length.\n\n"
            ...
            "fabricated experience or authority. Do not merely add more first person. "
            "Avoid formulaic markers such as I think, In my view, For me, I believe, "
            "My reading, or I urge unless that exact wording is already necessary and "
            "substantive. Do not paraphrase distinctive sentences merely for style."
        )
    return (
        "TARGETED REPAIR:\n"
