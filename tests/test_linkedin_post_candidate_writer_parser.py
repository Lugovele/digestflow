...
class LinkedInCandidateWriterParserTests(SimpleTestCase):
    ...
    def test_valid_multiline_post_text_with_escaped_newlines_parses(self) -> None:
        raw = _raw_response(
            json.dumps(
                {
    ...
    def test_literal_line_break_inside_quoted_post_text_fails(self) -> None:
        malformed = (
            '```json\n'
            '{\n'
            '  "post_text": "First paragraph.\n'
    ...
    def test_parser_does_not_repair_literal_newlines_inside_json_strings(self) -> None:
