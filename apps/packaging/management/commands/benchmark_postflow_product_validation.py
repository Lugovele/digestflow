...
class Command(BaseCommand):
    help = "Run provider-free PostFlow product validation benchmark infrastructure."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("candidate_writer_provider_calls: 0")
        self.stdout.write("semantic_grounding_provider_calls: 0")
        self.stdout.write("quality_evaluator_provider_calls: 0")
        self.stdout.write("repair_writer_provider_calls: 0")
